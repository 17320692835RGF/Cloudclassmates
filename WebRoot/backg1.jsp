  ...
  <div class="about-header-banner">
	...
	<!--  <div class="services">  -->
		...
		<% Items item = (Items)request.getAttribute("item"); %>
			<img src="<%=basePath %>upload/backg1.jpg" height="500px" width="900px">
		</div>
    	<form method="post" action="<%=basePath %>/servlet/LimitByTypeServlet?pageNum=1&itemType=自习教室#location">
